...
div.stTabs [data-baseweb="tab-highlight"] {
    background-color: #e05c20 !important;
}
...
.stSelectbox > div > div:hover {
    border-color:
        rgba(224,92,32,0.45) !important;
}

.stSelectbox svg {
    fill: #e05c20 !important;
}
